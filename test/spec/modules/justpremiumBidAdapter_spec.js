...
describe('justpremium adapter', function () {
  ...
  describe('buildRequests', function () {
    it('Verify build request and parameters', function () {
      ...
      expect(jpxRequest.ids.pubcid).to.equal('0000000')
      expect(jpxRequest.ids.tdid).to.equal('1111111')
      expect(jpxRequest.ids.id5id).to.equal('2222222')
      expect(jpxRequest.ids.digitrustid).to.equal('3333333')
    })
  })
